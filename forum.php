                ...
                <div class="w3-card w3-round w3-white">
                  <div class="w3-container w3-padding">
                    ...
                    <form action="chat.php" method="post">
                        Username: <input class="w3-border w3-padding" type="text" name="username"><br>
                        Message: <textarea name="message"></textarea>
                    </form>
    <!--                 
                    <p contenteditable="true" class="w3-border w3-padding">Username</p>
                    <p contenteditable="true" class="w3-border w3-padding">message-info</p> -->
            ...
            <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
             <svg xmlns="http://www.w3.org/2000/svg" class="w3-left w3-circle w3-margin-right" width="30" height="30" fill="currentColor" class="bi bi-person-fill-check" viewBox="0 0 16 16">
